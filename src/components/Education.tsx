      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {showWSUDiploma && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/90 p-2 backdrop-blur-sm sm:p-4 md:p-8">
            <div className="relative mx-auto my-2 flex w-full max-w-4xl max-h-[min(92dvh,56rem)] flex-col overflow-y-auto rounded-2xl border border-brand-primary/40 bg-[#0A0B10] p-4 shadow-2xl space-y-6 sm:p-6">
