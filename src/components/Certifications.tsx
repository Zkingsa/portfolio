  ...
  return (
    <section className="py-12 md:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {selectedCert && (
          <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden bg-black/90 p-2 backdrop-blur-sm sm:p-4 md:p-8 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden overscroll-contain">
            <div className="relative mx-auto my-3 w-full max-w-4xl">
              <div className="relative flex max-h-[min(92dvh,60rem)] flex-col overflow-hidden rounded-2xl border border-brand-primary/40 bg-[#0A0B10] shadow-2xl print-container-active sm:p-6">
                
                {/* Header */}
                <div className="flex items-center justify-between border-b border-gray-800 px-4 pb-3 pt-4 sm:px-0">
                ...
                <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 pb-4 pt-6 sm:px-0">
                  <div className="space-y-6">
                    ...
                    {/* Mode 3: Software Engineer Practitioner */}
                      ...
                      <div className="relative w-full max-w-[760px] aspect-auto bg-[#F8FBFF] text-slate-900 rounded-[3rem] border-[12px] border-blue-100 p-6 sm:p-8 shadow-[0_30px_70px_rgba(15,39,91,0.18)] overflow-hidden">
                        ...
                        <div className="relative flex flex-col items-center gap-5">
                          <div className="flex h-28 w-28 items-center justify-center rounded-full border-4 border-blue-200 bg-white shadow-[0_15px_40px_rgba(15,39,91,0.12)]">
                            <div className="text-3xl font-black text-slate-900">SE</div>
                          </div>
                          <div className="space-y-3 text-center">
                            <div className="text-[10px] font-semibold uppercase tracking-[0.45em] text-slate-500">
                              Coursera Verified Credential
                            </div>
                            <h3 className="text-3xl sm:text-5xl font-black tracking-tight text-slate-900 leading-none">
                              Software Engineer Practitioner
                            </h3>
                            <p className="mx-auto max-w-xl text-sm leading-6 text-slate-600">
                              Verified completion of the software engineering practitioner path, demonstrating applied software engineering principles and professional development in modern engineering practice.
                            </p>
                          </div>
                    ...
                    {/* Mode 4: Candidate Professional Development Badge */}
                    ...
                    {/* Mode 5: South African Professional Code 14 Driver's Licence */}
                    {selectedCert.id === "cert5" && (
